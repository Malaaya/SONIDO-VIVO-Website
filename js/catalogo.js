  ...
  contenedor.innerHTML = productosAMostrar.map(p => `
    <article class="shelf-product-card">
      ...
      <div class="shelf-product-body">
        ...
        <h3 class="shelf-product-title" style="font-weight: 700; color: #0f172a; margin: 0.3rem 0;">${p.nombre}</h3>
        ...
        <div style="display: flex; align-items: center; justify-content: space-between; margin-top: auto; padding-top: 0.8rem; border-top: 1px solid #f1f5f9;">
          ...
          <button class="btn-slide-cta" style="padding: 0.4rem 0.8rem; font-size: 0.85rem; border: none; cursor: pointer;" onclick="alert('Añadido: ${p.nombre}')">Agregar</button>
        </div>
      </div>
    </article>
  `).join('');
